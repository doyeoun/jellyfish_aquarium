...
JELLY_NAMES = ['파란 해파리', '분홍 해파리', '개구리 모자 해파리',
               ...
               '선인장 해파리', '눈사람 해파리', '황금 해파리', '무지개 해파리', '파분 해파리', '푸딩 해파리', '소다맛 푸딩 해파리', '벚꽃 해파리', '쌍둥이 해파리', '아기 해파리', '악마 해파리', '혼돈 해파리', '새싹 해파리', '해파리인 척 해파리', '홀로그램 해파리']
...
def get_unlocked_slots(inventory):
    ...
    if i.get(21,0)>=5 and i.get(22,0)>=3:       u.add(33)  # 자수정 (황금 5 + 무지개 3)
    return u
