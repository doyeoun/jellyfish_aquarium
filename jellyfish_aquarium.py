...
JELLY_NAMES = ['파란 해파리', '분홍 해파리', '개구리 모자 해파리',
               ...
               '선인장 해파리', '눈사람 해파리', '황금 해파리', '무지개 해파리', '파분 해파리', '푸딩 해파리', '소다맛 푸딩 해파리', '벚꽃 해파리', '쌍둥이 해파리', '아기 해파리']
...
class AquariumFish:
    ...
    def draw(self, surf):
        ...
        # 촉수
        tc  = (222, 158, 175) if self.design_idx == 28 else JELLY_DEFS[bi]['tc']
...
def _slot_base_idx(slot):
    return {0:0,1:1,2:0,3:0,4:2,5:0,6:3,7:4,8:5,9:6,10:7,11:8,12:9,13:10,14:11,15:12,16:13,17:14,18:15,19:16,20:17,21:18,22:23,23:24,24:19,25:20,26:21,27:22,28:0}.get(slot,0)
